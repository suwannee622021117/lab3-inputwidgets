...
import 'package:inputwidget117/models/drink.dart';
import 'package:inputwidget117/models/food.dart';
...
class ListItem {
  ...
  static getItem() {
    return [
      ...
      ListItem(2, 'อาหารตามสั่ง'),
      ListItem(3, 'อาหารปักษ์ใต้'),
      ListItem(4, 'อาหารภาคเหนือ'),
      ListItem(4, 'อาหารบุฟเฟ่ย์'),
    ];
  }
